...
minions['silverback'] = Minion("Slvrback", 1, 4, 3, 'taunt')
minions['thrallmar'] = Minion("Thrallmar", 2, 3, 3, 'windfury')
minions['flyingMachine'] = Minion("FlyMachin", 1, 4, 3, 'windfury')
minions['scarletCrusader'] = Minion("ScrltCrus", 3, 1, 3, 'divine')
minions['gnomeregan'] = Minion("Gnomergan", 1, 4, 3, ['charge', 'taunt'])

minions['yeti'] = Minion("Yeti", 4, 5, 4)
minions['tallstrider'] = Minion("Tallstridr", 5, 4, 4)
...
minions['silvermoonGuardian'] = Minion("SlvrMoon", 3, 3, 4, 'divine')

minions['bootyBay'] = Minion("BootyBay", 5, 4, 5, 'taunt')
minions['fenCreeper'] = Minion("FenCreep", 3, 6, 5, 'taunt')
...
minions['forceTank'] = Minion("FrceTank", 7, 7, 8, 'divine')
